using System.Text;
using ToDoer.API.Infrastructure.Middlewares.RequestResponseLogging;

namespace ToDoer.API.Infrastructure.Middlewares.ExceptionHandler
{
    public class RequestAndResponseLoggingMiddleware
    {
        private readonly RequestDelegate _next;

        private string path = Path.Combine(Environment.CurrentDirectory, "Errors", "erorrLogging.txt");
